...
public class Contrato implements Serializable {
    ...
    public Contrato(Short idContrato, String ubicacionC, int telefonoC, int celularC, String tipoC, Date fechaInicioC, String tipoPersonalC, short cantidadPersonalC, BigDecimal costoMensualC, String horarioC, Date fechaRegCon) {
        this.idContrato = idContrato;
